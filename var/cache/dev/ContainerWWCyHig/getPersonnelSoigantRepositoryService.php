 ...
 */
class getPersonnelSoigantRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PersonnelSoigantRepository' shared autowired service.
     *
     * @return \App\Repository\PersonnelSoigantRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PersonnelSoigantRepository.php';

        return $container->privates['App\\Repository\\PersonnelSoigantRepository'] = new \App\Repository\PersonnelSoigantRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
